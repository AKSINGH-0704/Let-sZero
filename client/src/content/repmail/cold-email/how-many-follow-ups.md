...
faqs:
  - question: "Isn't following up multiple times annoying?"
    answer: "Not if each message adds something: a new angle, a resource, or a genuine reason you are reaching out again. What reads as annoying is 'just checking in' with no new information, not the follow-up itself."
  - question: "What should the last email say?"
    answer: "A short, pressure-removing note, something like 'I'll assume the timing isn't right and won't follow up again.' It reliably earns replies from people who were mildly interested but had not gotten around to responding."
nextStep:
...
assets:
  - type: table
    ...
    content:
      ...
      rows:
        - ["1 (initial)", "n/a", "Your first, most personalized email"]
        - ["2", "3-4 days later", "A short, genuine bump with a new angle, not just \"checking in\""]
